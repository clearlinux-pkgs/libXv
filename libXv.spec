...
Source1  : http://xorg.freedesktop.org/releases/individual/lib/libXv-1.0.11.tar.gz.sig
...
cp %{_builddir}/libXv-1.0.11/COPYING %{buildroot}/usr/share/package-licenses/libXv/d1845ff7fcb2cdc1f5713dd18140e89de2ab0204
pushd ../build32/
%make_install32
